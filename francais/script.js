            ...
            switch (sectionId) {
                ...
                case 'training':
                    htmlContent = `
                        ...
                        <button onclick="showTopic('air')">Pollution de l'air</button>
                        <button onclick="showTopic('environment')">Pollution environnementale</button>
                        <button onclick="showTopic('water')">Pollution de l'eau et des océans</button>
                        <button onclick="showTopic('warming')">Réchauffement climatique</button>
                        <button onclick="showTopic('solid-waste')">Gestion des déchets solides</button>
                        <button onclick="showTopic('renewable-energy')">Énergie renouvelable</button>
                        <button onclick="showTopic('biodiversity')">Biodiversité</button>
                    `;
                ...
                case 'participate':
                    htmlContent = `
                        ...
                        <button onclick="startQuiz('air')">Pollution de l'air</button>
                        <button onclick="startQuiz('environment')">Pollution environnementale</button>
                        <button onclick="startQuiz('water')">Pollution de l'eau et des océans</button>
                        <button onclick="startQuiz('warming')">Réchauffement climatique</button>
                        <button onclick="startQuiz('solid-waste')">Gestion des déchets solides</button>
                        <button onclick="startQuiz('renewable-energy')">Énergie renouvelable</button>
                        <button onclick="startQuiz('biodiversity')">Biodiversité</button>
                    `;
                    developersSection.style.display = 'none';
                    break;
        ...
        function showTopic(topic) {
            ...
            content.innerHTML = `${info}<button onclick="showSection('training')">Retour à l'espace de formation</button>`;
        }
        // Démarrer le quiz
        ...
        function displayQuestion() {
            ...
            content.innerHTML = `
                ...
                `).join('')}
                <p>Temps restant: <span id="timer">20</span> secondes</p>
            `;
            let timeLeft = 20;
        ...
        function checkAnswer(selectedIndex, correctAnswerIndex) {
            ...
            if (selectedIndex === correctAnswerIndex) {
                ...
                content.innerHTML += `
                    ...
                    <button onclick="showTopicForRelearning('${question.topic}')">Revoir le sujet</button>
                `;
                wrongAnswers.push({
        ...
        function endQuiz(score) {
            ...
            content.innerHTML = `
                ...
                <button onclick="downloadCertificate()">Télécharger le certificat (PDF)</button>
                <button onclick="showWrongAnswers()">Afficher les réponses incorrectes</button>
                <button onclick="showSection('home')">Retour à la page d'accueil</button>
            `;
        }
